...
namespace Bam
{
    namespace GameMode
    {
        public static class GameMode
        {
            ...
            public static List<System.Type> GetAllClassesInheritingClass<T>(bool canBeAbstract = false)
            {
                ...
                foreach(Assembly assembly in assemblies)
                {
                    ...
                    {
                        if(type.IsClass && (canBeAbstract || !type.IsAbstract) && type.IsSubclassOf(typeof(T)))
                        {
                            results.Add(type);
