...
namespace Kojima
{
    ...
    public class CarResetter : MonoBehaviour
    {
        ...
        private Bam.Timer m_recordTimer;
        ...
        private void Update()
        {
            ...
            else if (m_shouldRecord && mRef_carController.AllWheelsGrounded && !mRef_carController.CurrentlyInWater)
            {
                //m_positions.push(transform.position);
                m_safePos = transform.position;
                m_shouldRecord = false;
